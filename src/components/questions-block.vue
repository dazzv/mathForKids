...
<template>
    <div class="questions-block d-flex flex-column align-items-center position-relative">
      ...
      <p class="conditions text-danger fw-normal">{{question.condition}}</p>
      <h5 class="question-text my-2 fw-normal">{{question.text}}</h5>
      <img :src="getImageUrl(question.image)" alt="queston-img" class="img-fluid my-3">
      ...
      <button v-if="сorrect" @click="nextQuestion" class="btn btn-secondary mt-2">Следующий вопрос</button>
